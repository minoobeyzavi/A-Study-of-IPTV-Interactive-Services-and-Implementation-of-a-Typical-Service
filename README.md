...
An interactive service is one that enables user to receive a transmission of data specially created for the recipient, or on request, whether or not as part of a program, which is selected by or on behalf of the recipient.
